...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleeunit/src/gleeunit.gleam", 50).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleeunit/src/gleeunit.gleam", 27).
-spec do_main() -> nil.
do_main() ->
    Options = [verbose,
        no_tty,
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleeunit/src/gleeunit.gleam", 9).
-spec main() -> nil.
main() ->
    do_main().
