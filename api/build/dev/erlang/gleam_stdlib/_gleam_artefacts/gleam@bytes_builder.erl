...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 34).
-spec new() -> gleam@bytes_tree:bytes_tree().
new() ->
    gleam_stdlib:identity([]).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 43).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 52).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 61).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 74).
-spec append_builder(
    gleam@bytes_tree:bytes_tree(),
    gleam@bytes_tree:bytes_tree()
) -> gleam@bytes_tree:bytes_tree().
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 87).
-spec prepend_string(gleam@bytes_tree:bytes_tree(), binary()) -> gleam@bytes_tree:bytes_tree().
prepend_string(Second, First) ->
    gleam_stdlib:iodata_append(gleam_stdlib:wrap_list(First), Second).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 97).
-spec append_string(gleam@bytes_tree:bytes_tree(), binary()) -> gleam@bytes_tree:bytes_tree().
append_string(First, Second) ->
    gleam_stdlib:iodata_append(First, gleam_stdlib:wrap_list(Second)).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 107).
-spec concat(list(gleam@bytes_tree:bytes_tree())) -> gleam@bytes_tree:bytes_tree().
concat(Builders) ->
    gleam_stdlib:identity(Builders).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 117).
-spec concat_bit_arrays(list(bitstring())) -> gleam@bytes_tree:bytes_tree().
concat_bit_arrays(Bits) ->
    gleam_stdlib:identity(Bits).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 128).
-spec from_string(binary()) -> gleam@bytes_tree:bytes_tree().
from_string(String) ->
    gleam_stdlib:wrap_list(String).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 139).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 149).
-spec from_bit_array(bitstring()) -> gleam@bytes_tree:bytes_tree().
from_bit_array(Bits) ->
    gleam_stdlib:wrap_list(Bits).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 162).
-spec to_bit_array(gleam@bytes_tree:bytes_tree()) -> bitstring().
to_bit_array(Builder) ->
    erlang:list_to_bitstring(Builder).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 172).
