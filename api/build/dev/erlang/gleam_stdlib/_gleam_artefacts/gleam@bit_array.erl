...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 11).
-spec from_string(binary()) -> bitstring().
from_string(X) ->
    gleam_stdlib:identity(X).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 24).
-spec byte_size(bitstring()) -> integer().
byte_size(X) ->
    erlang:byte_size(X).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 16).
-spec bit_size(bitstring()) -> integer().
bit_size(X) ->
    erlang:bit_size(X).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 49).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 62).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 57).
-spec is_utf8(bitstring()) -> boolean().
is_utf8(Bits) ->
    is_utf8_loop(Bits).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 90).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 82).
-spec to_string(bitstring()) -> {ok, binary()} | {error, nil}.
to_string(Bits) ->
    do_to_string(Bits).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 108).
-spec concat(list(bitstring())) -> bitstring().
concat(Bit_arrays) ->
    gleam_stdlib:bit_array_concat(Bit_arrays).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 35).
-spec append(bitstring(), bitstring()) -> bitstring().
append(First, Second) ->
    gleam_stdlib:bit_array_concat([First, Second]).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 114).
-spec base64_encode(bitstring(), boolean()) -> binary().
base64_encode(Input, Padding) ->
    gleam_stdlib:bit_array_base64_encode(Input, Padding).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 118).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 132).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 140).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 149).
-spec base16_encode(bitstring()) -> binary().
base16_encode(Input) ->
    binary:encode_hex(Input).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 153).
-spec base16_decode(binary()) -> {ok, bitstring()} | {error, nil}.
base16_decode(Input) ->
    gleam_stdlib:base16_decode(Input).

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 172).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 167).
-spec inspect(bitstring()) -> binary().
inspect(Input) ->
    <<(inspect_loop(Input, <<"<<"/utf8>>))/binary, ">>"/utf8>>.

-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 214).
...
-file("/Users/devsharpe/Projects/euphoria/api/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 254).
